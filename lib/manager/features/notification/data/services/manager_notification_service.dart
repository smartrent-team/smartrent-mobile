...
const String _managerNotificationCacheKey = 'manager_notification_cache_v1';
...
class ManagerNotificationService {
  ManagerNotificationService._();

  static final ManagerNotificationService instance = ManagerNotificationService._();
  ...
  Future<List<TenantNotification>> getCachedNotifications() async {
    ...
    final cached = prefs.getString(_managerNotificationCacheKey);
  ...
  Future<void> registerDeviceToken() async {
    try {
      ...
      debugPrint('Error registering device token for manager: $e');
    }
  }
